...
public:
    ...
    inline PacketTrace       GetTrace(void)            { return PacketTrace( ID, Priority, Elapsed, PctSize ); }
    inline void        GetTrace( PacketTrace& trc )    { trc.SourceID   = ID;
    ...
    ////////////////////////////////////////////////////////////////////////////////
    inline void ExtractPacket(PacketTrace& trc)
    {
        GetTrace( trc );
        ExtractPacket();
    }
