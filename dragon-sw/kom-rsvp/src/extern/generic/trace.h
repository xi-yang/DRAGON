...
public:
    ...
    PacketTrace( int16s sid = 0, int16s qid = PRIOR_L0, bytestamp_t bs = 0.0, pct_size_t ps = 0 )   
    { 
        SourceID   = sid;
        QueueID    = qid;
        ByteStamp  = bs;
    ...
    { 
				if ( ByteStamp < free_stamp + PacketSize ) ByteStamp = free_stamp + PacketSize;
//        ByteStamp = MAX( ByteStamp, free_stamp + PacketSize );
    }
};

////////////////////////////////////////////////////////////////////////////////
// FUNCTION:    ostream& operator<< ( ostream& os, const PacketTrace& trc )
// DESCRIPTION: Insert operator for the class PacketTrace
// NOTES:
////////////////////////////////////////////////////////////////////////////////
inline ostream& operator<< ( ostream& os, const PacketTrace& trc )
{
