...
private:
    ...
    PacketTrace       NextPacket;     /* Future packet */
...
public:
    ...
    ////////////////////////////////////////////////////////////////////////////////
    // FUNCTION:    PacketTrace PeekNextPacket(void)
    // DESCRIPTION: Peek at next packet before it arrives
    // NOTES:
    ////////////////////////////////////////////////////////////////////////////////
    inline PacketTrace PeekNextPacket(void)   { return NextPacket; }

    ////////////////////////////////////////////////////////////////////////////////
    // FUNCTION:    PacketTrace GetNextPacket(void)
    // DESCRIPTION: Return the next packet from the aggregated traffic
    // NOTES:
    ////////////////////////////////////////////////////////////////////////////////
    PacketTrace GetNextPacket(void)
    {
        PacketTrace trc = NextPacket;
        if( SRC.GetHead() )
        {
