...
ONetworkBuffer& operator<< ( ONetworkBuffer& buffer, const DRAGON_UNI_Object& o ) {
	buffer << RSVP_ObjectHeader( o.size(), (uint8)(const_cast<DRAGON_UNI_Object>(o).getClassNumber()), 1);
...
ONetworkBuffer& operator<< ( ONetworkBuffer& buffer, const GENERALIZED_UNI_Object& o ) {
	buffer << RSVP_ObjectHeader( o.size(), (uint8)(const_cast<GENERALIZED_UNI_Object>(o).getClassNumber()), 1);
