...
public:
	enum Type { InitAPI = 0, Path = 1, Resv, PathErr, ResvErr, PathTear, ResvTear, ResvConf, Ack = 13, Srefresh = 15, Load = 126, PathResv = 127,
				  RemoveAPI = 255, /*hacked*/ AddLocalId = 201, DeleteLocalId = 202, RefreshLocalId = 203, VtagNotification = 204, };
...
public:
	...
	bool hasRSVP_HOP_Object() const { return (objectFlags & RSVP_HOP); }
