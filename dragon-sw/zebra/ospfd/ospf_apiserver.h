...
/*Calculating an explicit path for a pair of source and destination.
 *Implemented in ospf_cspf.c
 */

extern list
ospf_cspf_explicit_route (struct ospf_area *area, struct in_addr src_ip, 
                    struct in_addr dest_ip, u_int8_t SwitchingCapability);
...
/* -----------------------------------------------------------
 *  OSPF_APISERVER - NARB interface functions
 * -----------------------------------------------------------
 */
