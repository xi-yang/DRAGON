...
#define PRIORITY(I)		((I)->nbr_self->priority)
  ...
  struct thread *t_te_linklocal_lsa_self;   /* Type-9 te-link-LSAs */
  /* The reason to put area-lsa related structure here is because per RFC3630
    * a TE-LSA is for an individual interface, not for the entire area
    * " Only one Link TLV shall be carried in each LSA, allowing for fine
    * granularity changes in topology."
    */
  struct thread *t_te_area_lsa_link_self;	/* Type-10 te-area link LSAs */
#endif /* HAVE_OPAQUE_LSA */
...
/* TE flag: indicate if TE is enabled on  this interface */
#define INTERFACE_NO_TE			0
#define INTERFACE_TE_MPLS			1
#define INTERFACE_TE_GMPLS			2
  u_char  te_enabled; 
...
struct ospf_lsa *te_linklocal_lsa_self;		/* Type-9 LSA  */

/*@@@@UNI hacks*/
struct uni_data* uni_data;
};
