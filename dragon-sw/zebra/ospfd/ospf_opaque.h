 ...
 */
#define OPAQUE_TYPE_TE_LINKLOCAL_LSA	1		/* for type-9 te-link-local-LSA, status TBD */
#define OPAQUE_TYPE_TE_AREA_LSA		1		/* for type-10 te-area-LSA */
...
extern list ospf_get_opaque_funclist (u_char lsa_type);
